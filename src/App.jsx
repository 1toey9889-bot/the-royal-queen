...
export default function App() {
  ...
  const navItemActiveStyle = "bg-gradient-to-r from-[#0A142A] via-[#152747] to-[#1d3560] text-[#F3D999] font-bold shadow-lg shadow-[#0A142A]/25 border-[#CEA85E]/40";
  const navItemInactiveStyle = "text-slate-600 hover:bg-[#FFF8EA] hover:text-[#9A7434] font-medium hover:border-[#EADBBB]";
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row font-sans w-full overflow-hidden relative">
      ...
      <div className={`w-full ${isSidebarCollapsed ? 'md:w-[80px]' : 'md:w-64'} bg-gradient-to-b from-white/90 to-[#FFFBF2]/90 backdrop-blur-xl border-b md:border-r border-[#EADBBB]/70 flex-shrink-0 z-[40] relative overflow-hidden transition-all duration-300 ease-in-out shadow-sm`}>
        <div className="relative z-10 flex flex-col h-full">
          {!isSidebarCollapsed && (
             <div className="p-4 flex items-center justify-center border-b border-[#EADBBB]/60 transition-all duration-300">
